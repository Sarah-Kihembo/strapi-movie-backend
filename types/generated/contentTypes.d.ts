...
export interface ApiScienceFictionScienceFiction extends Schema.CollectionType {
  collectionName: 'science_fictions';
  info: {
    singularName: 'science-fiction';
    pluralName: 'science-fictions';
  ...
  attributes: {
    ...
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      'api::science-fiction.science-fiction',
      'oneToOne',
      'admin::user'
    > &
      Attribute.Private;
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::science-fiction.science-fiction': ApiScienceFictionScienceFiction;
    }
  }
}
